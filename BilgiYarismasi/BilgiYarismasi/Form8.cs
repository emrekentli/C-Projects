...
namespace BilgiYarismasi
{
    public partial class Form8 : Form
    {
        ...
        {
            label3.Text = Form7.joker1.ToString();
            label4.Text = Form7.joker2.ToString();
            label5.Text = Form7.joker3.ToString();
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            if (joker1 == 1)
            {
                joker1--;
                Form9 form9 = new Form9();
                form9.label3.Text = joker1.ToString();
        ...
        private void pictureBox3_Click(object sender, EventArgs e)
        {
            ...
            if (joker2 == 1)
            {
                joker2--;
                Form9 form9 = new Form9();
                form9.label4.Text = joker2.ToString();
        ...
        private void pictureBox4_Click(object sender, EventArgs e)
        {
            ...
            if (joker3 == 1)
            {
                ...
                MessageBox.Show("Aradığınız kişi cevabın Kano olduğunu düşünüyor");
                Form9 form9 = new Form9();
                form9.label5.Text = joker3.ToString();
            }
            else
            {
                MessageBox.Show("Bu jokeri daha önce kullandınız.");
