...
namespace BilgiYarismasi
{
    public partial class Form4 : Form
    {
        ...
        {
            label3.Text = Form3.joker1.ToString();
            label4.Text = Form3.joker2.ToString();
            label5.Text = Form3.joker3.ToString();
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            if (joker1 == 1)
            {
                joker1--;
                Form5 form5 = new Form5();
                form5.label3.Text = joker1.ToString();
        ...
        private void pictureBox3_Click(object sender, EventArgs e)
        {
            ...
            if (joker2 == 1)
            {
                joker2--;
                Form5 form5 = new Form5();
                form5.label4.Text = joker2.ToString();
        ...
        private void pictureBox4_Click(object sender, EventArgs e)
        {
            if (joker3 == 1)
            {
                ...
                MessageBox.Show("Aradığınız kişi cevabın Hakan Şükür olduğunu düşünüyor");
                Form5 form5 = new Form5();
                form5.label5.Text = joker3.ToString();
            }
            else
            {
                MessageBox.Show("Bu jokeri daha önce kullandınız.");
