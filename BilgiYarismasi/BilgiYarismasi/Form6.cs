...
namespace BilgiYarismasi
{
    public partial class Form6 : Form
    {
        ...
        {
            label3.Text = Form5.joker1.ToString();
            label4.Text = Form5.joker2.ToString();
            label5.Text = Form5.joker3.ToString();
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            if (joker1 == 1)
            {
                joker1--;
                Form7 form7 = new Form7();
                form7.label3.Text = joker1.ToString();
        ...
        private void pictureBox3_Click(object sender, EventArgs e)
        {
            ...
            if (joker2 == 1)
            {
                joker2--;
                Form7 form7 = new Form7();
                form7.label4.Text = joker2.ToString();
        ...
        private void pictureBox4_Click(object sender, EventArgs e)
        {
            ...
            if (joker3 == 1)
            {
                ...
                MessageBox.Show("Aradığınız kişi cevabın Diyarbakır olduğunu düşünüyor");
                Form7 form7 = new Form7();
                form7.label5.Text = joker3.ToString();
            }
            else
            {
                MessageBox.Show("Bu jokeri daha önce kullandınız.");
