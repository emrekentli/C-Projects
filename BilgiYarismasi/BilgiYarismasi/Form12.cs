...
namespace BilgiYarismasi
{
    public partial class Form12 : Form
    {
        ...
        {
            label3.Text = Form11.joker1.ToString();
            label4.Text = Form11.joker2.ToString();
            label5.Text = Form11.joker3.ToString();
        ...
        private void pictureBox4_Click(object sender, EventArgs e)
        {
            ...
            if (joker3 == 1)
            {
                ...
                MessageBox.Show("Aradığınız kişi emin olmamakla birlikte cevabın Tuvalu olduğunu düşünüyor");
